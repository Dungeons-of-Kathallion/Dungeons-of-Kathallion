...
if plugin_vanila.lower().startswith('p'):
    ...
    with open(what_plugin + "plugin/map.yaml") as f:
        map = yaml.safe_load(f)

    with open(what_plugin + "plugin/items.yaml") as f:
        item = yaml.safe_load(f)

    with open(what_plugin + "plugin/enemies.yaml") as f:
        enemy = yaml.safe_load(f)

    with open(what_plugin + "plugin/start.yaml") as f:
        start_player = yaml.safe_load(f)

    with open(what_plugin + "plugin/lists.yaml") as f:
        lists = yaml.safe_load(f)

    with open(what_plugin + "plugin/plot.yaml") as f:
        plot = yaml.safe_load(f)

    with open(what_plugin + "plugin/ammo.yaml") as f:
